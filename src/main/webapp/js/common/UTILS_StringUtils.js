...
UTILS.StringUtils = (function() {
   ...
   * @method module.StringFormat
   * @public
   *
   * @param str {String} {Required} String to be formatted.
  ...
  module.removeDiacritics = function(str) {
    for (var i = 0; i < defaultDiacriticsRemovalMap.length; i = i + 1) {
  ...
  module.toHash = function(str) {

    var output = str;
    output = output.replace(/ /g, '');
    output = module.removeDiacritics(output);
